...
-- Escreva uma query para exibir o nome como "Nome do Projeto" e as horas como
...
-- Escreva uma query que exiba a string "O projeto Name precisou de Hours horas para ser concluído."
-- para cada projeto.
SELECT
