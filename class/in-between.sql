...
FROM
    sakila.payment
WHERE
	payment_date BETWEEN '2005-05-01' AND '2005-08-05';
...
-- direcionados para as classificações indicativas G, PG e PG-13 . Os resultados devem
-- estar ordenados por título.
SELECT 
    title, rating
FROM
    sakila.film
